...
// This proxy can be created by calling TiFancyLabel.createExample({ message: 'hello world' })
@Kroll.proxy(creatableInModule = TiFancyLabelModule::class)
