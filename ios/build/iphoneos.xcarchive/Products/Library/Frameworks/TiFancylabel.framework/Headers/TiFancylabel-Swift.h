...
#ifndef TIFANCYLABEL_SWIFT_H
#define TIFANCYLABEL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TiFancylabel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSCoder;
SWIFT_CLASS_NAMED("TiFancylabelLabel")
@interface TiFancylabelLabel : TiUIView
...
SWIFT_CLASS_NAMED("TiFancylabelLabelProxy")
@interface TiFancylabelLabelProxy : TiViewProxy
